        ...
        <div className="staking-history-board">
          <div className="staking-history-header">
            <div className="header-left">
              <div>{t('s_rewardHistory')}</div>
              <div> {t('s_earned')}: {totalRewards.toFixed(2)} WAX</div>
            </div>
            <div className="header-right">
              <div>{t('s_estRewards')}</div>
              <div>{dailyRewards ? dailyRewards.toFixed(2): '0.00' } {t('s_wax_per_day')}</div>
            </div>
          </div>
          <div className="staking-history-body">
            ...
            <div className="history-body-right">
              <div className="history-body-des">
                <div>Est. APR</div>
                <div>4.39% {t('s_anually')}</div>
              </div>
              <div className="history-body-des">
                <div>{t('s_monthlyRewards')}</div>
