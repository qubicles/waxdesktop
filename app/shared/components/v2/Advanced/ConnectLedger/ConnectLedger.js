                    ...
                    <div className="connectLedger-section">
                        ...
                        <div className="connectLedger-body">
                            ...
                            <div className="ledger-content">
                                <div className="ledger-content-header">
                                    <div className="ledger-content-header-left">
                                        <img src={require('../../../../../renderer/assets/images/advanced/Group1731.png')} />
                                        <div>Ledger</div>
                                    </div>
                                ...
                                <div className="ledger-content-body">
                                    ...
                                    <p>Connect a Leger Wallet Device via USB to your computer running this app.</p>
                                    <p>Unlock the device using your PIN code.</p>
                                    <p>Ensure the WAX application is installed on the device (Using Ledger Live)</p>
                            ...
                            <div className="seller-input">
                                ...
                                <input type="text" className="common-input" placeholder="Enter the key" />
                            </div>
