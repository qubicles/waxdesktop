...
import "./WhiteListedAppsRow.global.css";

class WhiteListedAppsRow extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
...
WhiteListedAppsRow.propTypes = {};

WhiteListedAppsRow.defaultProps = {};

export default WhiteListedAppsRow;
