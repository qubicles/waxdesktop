      ...
      serverInstructions = (
        <Message
          ...
          content={(
            <p>
              <a
                onClick={() => this.openLink('https://github.com/qubicles/waxdesktop/blob/master/nodes.md')}
                onKeyPress={() => this.openLink('https://github.com/qubicles/waxdesktop/blob/master/nodes.md')}
                role="link"
